...
def discrete_sample(w, n, rng=random, log_mode=False, temperature=1):
    """
    ...
    :param temperature: The soft-max annealing temperature. A temperature of 1 corresponds to no modification to *w*.
